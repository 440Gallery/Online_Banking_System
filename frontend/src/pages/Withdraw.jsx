...
const Withdraw = () => {
  ...
  const handleWithdraw = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post('/transactions/withdraw', { amount: Number(amount), description });
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Withdraw Money</h2>
